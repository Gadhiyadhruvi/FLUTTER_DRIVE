...
import 'package:budgettracker/models/Myexpense.dart';
import 'package:budgettracker/models/Mysaving.dart';
import 'package:budgettracker/repository.dart';
...
class MyServices {
  ...
  insertExpenseService(MyExpense myExpense) async {
    return await _repository.insertExpense(
        "myexpense", myExpense.MyExpenseMap());
  }
  ...
  insertTransactionService(MyTransaction myTransaction) async {
    return await _repository.insertBudget(
        "mytransaction", myTransaction.MyTransactionMap());
  }
  ...
  deleteDataTransactionService(transactionID) async {
    return await _repository.deleteEntryFromTransaction(
